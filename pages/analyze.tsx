    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex flex-col items-center justify-center px-6 py-8 relative min-h-[calc(100vh-100px)]">
        ...
        {!isAnalyzing && analysis && !error && !playlist && (
          <div className="mt-8 w-full max-w-2xl bg-[#F5F1E8] rounded-xl p-6 shadow-lg">
            ...
            <Button
              ...
              className="mt-6 bg-[#504E76] hover:bg-[#64628A] text-white w-full"
              size="lg"
            >
              <Music className="w-5 h-5" />
              <span>View Playlist Preview</span>
